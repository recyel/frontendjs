...
export default function VerificationRequest() {
  ...
  return (
    <div>
      <div className="mt-24 items-center flex justify-center flex-col">
       <div>
        <svg
        width="293"
        height="80"
      ...
      <TrustLogo/>
       ...
       <div className="mt-14 flex flex-col text-center font-bold  text-bold text-white border m-12 px-4 py-4 rounded-lg border-[#575757] lg:w-[600px] w-96 lg:max-w-4xl">
        <h2 className="scroll-m-20 text-4xl font-bold tracking-tight lg:text-2xl text-white">You have been requested to authorize wallet AML verification </h2>
